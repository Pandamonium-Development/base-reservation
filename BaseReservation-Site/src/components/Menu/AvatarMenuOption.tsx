...
interface AvatarMenuOptionProps {
    UserName: string | undefined
}

export const AvatarMenuOption = ({ UserName }: AvatarMenuOptionProps) => {
    ...
    return (
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
            {!isMobile && (<Typography variant='body2' sx={{ minWidth: '9rem' }}>{UserName ?? 'Usuario'}</Typography>)}
            <Avatar
